...
BATCH='RESEARCH_GSM0172RRMS_27062024'
...
cd "${WORKING_DIR}/filtered_reads2"
...
do 
    ...
    modkit pileup "${WORKING_DIR}/filtered_reads2/${SAMPLE_NAME}" "${WORKING_DIR}/bedmethyl2/${BATCH}_${SAMPLE_NAME}.bed" --cpg --combine-strands --threads 10 --ref "${REFERENCE_DIR}/GCA_000001405.15_GRCh38_no_alt_analysis_set.fna" --include-bed "${REFERENCE_DIR}/RRMS_human_hg38.bed" --no-filtering
